...
Block computeReward(std::map<int, Client> &clients, std::vector<Message> &messages, std::map<int, struct timeval> &begins, const Miner &miner, float maxReward = 0.25f, long usecThresh = 100000)
{
